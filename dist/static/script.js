...
},{"./main_menu.js":2}],2:[function(require,module,exports){
'use strict';

var mainNavElement = document.getElementById('main-nav');
var mainNavVisibleElement = document.getElementById('main-nav-toggle');

mainNavVisibleElement.addEventListener('click', function () {
